    ...
    >
      <v-card class="mx-4 mb-3" style="border-radius: 10px">
        <v-row no-gutters class="pt-3 px-3">
          ...
          <v-col cols="12" lg="3" class="mb-lg-1 mb-md-1 mt-3 pr-3">
            <InputSelect
          ...
          <v-col cols="12" lg="5" class="mb-lg-1 mb-md-1 mt-3 pr-3">
            <InputTextField
              class="pl-2"
              style="border-radius: 10px"
                  ...
                  <v-col cols="12">
                    <v-row no-gutters class="px-4 pb-4">
                      ...
                      <v-col cols="12" class="overline">
                        cut-off:
                        {{
                          new Date(scholarshipOffer.cutOff).toLocaleDateString()
                        }}
                      </v-col>
                      <v-col cols="12" class="mt-4">
                        <v-btn
...
export default {
  ...
  methods: {
    ...
    getScholarships({
      ...
      this.$axios
        .$get("/scholarship/", { params: { page, search, type, _type } })
        .then(({ items, length }) => {
    ...
    setScholarship({
      ...
      if (value.cutOff) {
        value.cutOff = new Date(value.cutOff).toISOString().slice(0, 10);
      }
